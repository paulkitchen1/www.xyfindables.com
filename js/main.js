...
$(document).ready(function () {
    ...
    (function () {
        ...
        if (!isMobile) {
            ...
            var prepVideo = function () {
                var videoPlayer = document.getElementById("top-video");
                ...
                videoPlayer.onsuspend = function () {
                    if (justStarted) {
                        ...
                        setTimeout(function () { videoPlayer.play(); }, 300);
                        justStarted = false;
                    }
                }
            }();
    ...
    if (navigator.userAgent.indexOf("iPad") != -1 || navigator.userAgent.indexOf("iPhone") != -1) { $(".play-store").remove(); }
});
